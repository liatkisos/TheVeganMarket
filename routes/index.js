...
router.get('/login', async (req, res) => {
    ...
    if (req.session.user) {
        ...
        res.json({ status: "error", msg: "Your Email address or password is incorrect!" });
...
router.post('/cart_product', async (req, res) => {
    ...
    if (req.session.user.role == "user" && req.body.quantity > 0 && req.body.quantity % 1 == 0) {
        ...
        if (cartOpen) {
            ...
            let dateToSet = `${dateArry[0]}/${dateArry[1]}/${dateArry[2]}`;
...
router.post('/check_delivery_date', async (req, res) => {
    ...
    let fixDate = `${dateArry[0]}/${dateArry[1]}/${dateArry[2]}`;
...
//create categories http://localhost:3000/api/create_categories
// router.get('/create_categories', async (req, res) => {

//     let c1 = new categoriesModel({ categoryName: "Fresh Produce" });
//     let c2 = new categoriesModel({ categoryName: "Refrigerated" });
//     let c3 = new categoriesModel({ categoryName: "Frozen" });
//     let c4 = new categoriesModel({ categoryName: "Drinks" });
//     let c5 = new categoriesModel({ categoryName: "Sweets" });
